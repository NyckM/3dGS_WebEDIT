...
rep('    <a class="btn ghost" id="btn-criar" href="criar.html">✨ Criar meu splat (foto, vídeo, 4D) — guia passo a passo</a>',
...
document.getElementById('btn-criar').addEventListener('click', function (e) {
  e.preventDefault();
